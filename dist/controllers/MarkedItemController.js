...
const getMarkedItemsByUserId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield database_1.pool.query('SELECT mi.*, i.num_reviews, i.rating, i.food_name, i.brand_name, i.image_url FROM markedItems mi JOIN items i ON mi.item_id=i.id WHERE user_id = $1', [userId]);
